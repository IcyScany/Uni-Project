...
const p = h('{\n    "address": [\n        "127.0.0.1",\n        "192.168.221.1",\n        "192.168.52.1",\n        "172.29.24.197"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**/*.js",\n        "E:/HBuilderX.3.6.4.20220922/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), m = h('[{"provider":"aliyun","spaceName":"space1","spaceId":"15d41c0d-c06c-4842-8596-f67a916fcf5e","clientSecret":"/pE/zvu99+7aWyLRWPW9zw==","endpoint":"https://api.bspapp.com"}]') || [];
let _ = "";
try {
  _ = "__UNI__F160505";
} catch (e) {
